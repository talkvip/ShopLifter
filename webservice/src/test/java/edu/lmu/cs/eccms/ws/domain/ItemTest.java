...
public class ItemTest {
    ...
    public void fieldsSetBySettersCanBeRead() {
        ...
        assertThat(i.getName(), is("Some car"));
        assertThat(i.getSku(), is(867));
        assertThat(i.getQuantity(), is(123));
        assertThat(i.getDescription(), is("A motor vehicle."));
        assertThat(i.getPrice(), is(5309.0));
        assertThat(i.getDimension(), is(d));
        assertThat(i.getItemHistory(), is(ih));
    ...
    public void toStringProducesExpectedString() {
        Dimension d = new Dimension(10, 2.0, 3.0, 4.0, 63.5);
        ItemHistory ih = new ItemHistory();
        Item item1 = new Item(5L, true, "Some car", 867, 100, "A motor vehicle.",
                5309.0, d, ih);


        String expected1 = "Item{id=5, active=true, name=Some car, sku=867, quantity=100, description=A motor vehicle., price=5309.0, dimension=Dimension{count=10, height=2.0, width=3.0, depth=4.0, weight=63.5}}";
        Item item2 = new Item();
        item2.setId(5L);
        ...
        String expected2 = "Item{id=5, active=true, name=Some car, sku=867, quantity=100, description=A motor vehicle., price=5309.0, dimension=Dimension{count=10, height=2.0, width=3.0, depth=4.0, weight=63.5}}";
    ...
    public void hashCodeProducesId() {
        assertThat(new Item(5L, true, "Some car", 867, 100, "A motor vehicle.",

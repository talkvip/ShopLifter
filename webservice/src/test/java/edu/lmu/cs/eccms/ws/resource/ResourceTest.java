...
import edu.lmu.cs.eccms.ws.resource.StringListMessageBodyProvider;
...
public abstract class ResourceTest extends JerseyTest {
    ...
    protected AppDescriptor configure() {
        return configure("edu.lmu.cs.eccms.ws.resource.SecurityContextContainerRequestFilter");
    }
    ...
    protected AppDescriptor configure(String securityContextClassName) {
        ...
        return new WebAppDescriptor.Builder("edu.lmu.cs.eccms.ws.resource")

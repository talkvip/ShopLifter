...
%  1.0.1  18-Mar-2013  A. Won        Revised per professor instruction
%
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
these are natural to think of, but the third is the elusive trouble-maker
...
they realized that there may have been an explosion resulting from hazardous materials,
...
which in this case happened to be a combination of three tires and five
...
``oxygen canisters --empty'' written on it.  They then sat around for another
few days.  Finally, on May 11, 1996, the boxes containing the oxygen
...
concerned about ValuJet long before the crash of Flight 592 because of
a ``disproportionate number of infractions''
...
of people, but circumventing ethical concerns may appear beneficial to some
...
absence, are protected by laws, require payroll taxes, and have to be paid even
...
actual ability to regulate anybody;
with contradicting mandates and not enough people to watch over every airline
employee, the FAA was wholly inadequate to ensure anyone's safety.  The best that the
...
each employee more money, Pink's argument is that employees should not spend
their time thinking about ways to make more money.  Employees should spend time
caring about their work and the results of their work, and having to be concerned
about finances can be distracting.
...
of rigid time lines and simple paperwork to ensure success has proven to be
...
there is always the chance of errors occurring that are unforeseen and
